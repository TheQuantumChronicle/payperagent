...
echo ""
echo -e "${YELLOW}━━━ New Free APIs Tests (Expecting 402) ━━━${NC}"
test_endpoint "Jokes Random (402)" "$API_URL/api/jokes/random" "402" ".payment"
test_endpoint "Bored Activity (402)" "$API_URL/api/bored/activity" "402" ".payment"
test_endpoint "Name Age Predictor (402)" "$API_URL/api/name/age?name=John" "402" ".payment"
test_endpoint "Name Gender Predictor (402)" "$API_URL/api/name/gender?name=Emma" "402" ".payment"
test_endpoint "Name Nationality (402)" "$API_URL/api/name/nationality?name=Chen" "402" ".payment"
test_endpoint "Name All Predictors (402)" "$API_URL/api/name/all?name=Maria" "402" ".payment"
